...
namespace sdds {
	...
	public:
		...
		Student(const char* name); // Used to provide flexibility for client code to initialize objects with specific, predetermined values.
		                           //Allow objects to be created with specific initializations based on the arguments provided.

		Student();  // No argument constructor	(Used to create an object with default or safe empty state. 
